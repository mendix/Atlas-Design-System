...
public class Slider
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "Atlas_DesignSystem.Slider"));
	}
	...
	protected Slider(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject sliderMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("Atlas_DesignSystem.Slider", sliderMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a Atlas_DesignSystem.Slider");
	...
	public static atlas_designsystem.proxies.Slider initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return atlas_designsystem.proxies.Slider.load(context, mendixIdentifier);
	}
	...
	{
		return "Atlas_DesignSystem.Slider";
	}

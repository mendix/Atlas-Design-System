...
public class ProgressCircle
{
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "Atlas_DesignSystem.ProgressCircle"));
	}
	...
	protected ProgressCircle(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject progressCircleMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("Atlas_DesignSystem.ProgressCircle", progressCircleMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a Atlas_DesignSystem.ProgressCircle");
	...
	{
		return "Atlas_DesignSystem.ProgressCircle";
	}
